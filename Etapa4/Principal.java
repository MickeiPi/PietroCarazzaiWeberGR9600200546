...
public static void main(String[] args) {
    ...
    while (true) {
        ...
        if (scan.equals("1")) {
            ...
            System.out.println("Informe o tamanho do estoque de produtos: ");
            tamanho = scanner.nextInt();
            
            dataFundacao = new Data(dia, mes, ano);
            endereco = new Endereco(nomeDaRua, cidade, estado, pais, cep, numero, complemento);
            loja1 = new Loja(nome, quantidadeFuncionarios, salarioBaseFuncionario, endereco, dataFundacao, tamanho);
